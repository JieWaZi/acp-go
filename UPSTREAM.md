...
- event/tool/approval/config/content/auth 已作为独立小接口组件实现；它们与子进程、session/turn runtime、prompt/steering 和 Agent composition root 的最终 wiring 由后续 stabilization 子变更完成。
