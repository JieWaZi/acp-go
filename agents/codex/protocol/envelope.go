...
type clientRequestEnvelope[P any] struct {
	...
	method string
	// includeParams 区分普通请求与 upstream 定义 params 为 undefined 的请求。
	includeParams bool
}
...
// newClientRequestWithoutParams 创建 upstream 将 params 定义为 undefined 的固定方法请求。
