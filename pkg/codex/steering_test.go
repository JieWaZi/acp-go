...
// TestNoActiveTurnToSteerErrorAcceptsSupportedDataShapes 验证同时识别 string data 与 object.details。
func TestNoActiveTurnToSteerErrorAcceptsSupportedDataShapes(t *testing.T) {
	t.Parallel()
	tests := []struct {
